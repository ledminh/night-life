	  ...
	  _createClass(Results_Screen, [{
	    ...
	    value: function componentWillReceiveProps(nextProps) {
	      ...
	      if (nextProps.data !== this.props.data) {
	        ...
	        var result = {
	          title: nextProps.data[index].name,
	          description: nextProps.data[index].snippet_text,
	          url: nextProps.data[index].url,
	          rating_url: nextProps.data[index].rating_img_url,
	          image: nextProps.data[index].image_url
	        };

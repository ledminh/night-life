...
/***/ function(module, exports, __webpack_require__) {
	...
	var Results_Screen = function (_React$Component) {
	  ...
	  function Results_Screen(props) {
	    ...
	    _this.onClick_button_going = _this.onClick_button_going.bind(_this);
	  ...
	  _createClass(Results_Screen, [{
	    ...
	    value: function onClick_button_going(index) {
	      var _this2 = this;

	      var xhr = new XMLHttpRequest();

	      xhr.open("POST", "/submit-going", true);
	      xhr.send(this.props.data[index].id);

	      xhr.onreadystatechange = function () {
	        if (xhr.readyState === 4 && xhr.status === 200) {
	          var number_going = Number(xhr.responseText);
	          _this2.state.data_list[index].number_going = number_going;

	          _this2.forceUpdate();
	          _this2.refs.List.setCurrentBar(index);
	          _this2.loadResult(index);
	        }
	      };
	    }
	  }, {
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(List, { data: this.state.data_list, loadResult: this.loadResult,
	          onClick_button_going: this.onClick_button_going,
	          ref: "List" })
	      );
	    }
	  }]);
	...
	var Result = function (_React$Component2) {
	  ...
	  function Result(props) {
	    ...
	    _this4.onClick_result_title = _this4.onClick_result_title.bind(_this4);
	    return _this4;
	  }
	...
	var List = function (_React$Component3) {
	  ...
	  function List(props) {
	    ...
	    var _this5 = _possibleConstructorReturn(this, Object.getPrototypeOf(List).call(this, props));
	    ...
	    //Binding
	    _this5.setCurrentBar = _this5.setCurrentBar.bind(_this5);
	    window.onkeydown = _this5.onKeyDown.bind(_this5);
	    return _this5;
	  }
	  ...
	  _createClass(List, [{
	    ...
	    value: function render() {
	      ...
	      this.props.data.forEach(function (result, i) {
	        result_bars.push(_react2.default.createElement(Result_Bar, { key: i, index: i, current_bar: _this6.state.current_bar,
	          loadResult: _this6.props.loadResult, name: result.name,
	          number_going: result.number_going, setCurrentBar: _this6.setCurrentBar,
	          onClick_button_going: _this6.props.onClick_button_going }));
	      });
	...
	var Result_Bar = function (_React$Component4) {
	  ...
	  function Result_Bar(props) {
	    ...
	    //Binding
	    var _this7 = _possibleConstructorReturn(this, Object.getPrototypeOf(Result_Bar).call(this, props));

	    _this7.onClick_name = _this7.onClick_name.bind(_this7);
	    _this7.getBackgroundColor = _this7.getBackgroundColor.bind(_this7);
	    _this7.onClick_button_going = _this7.onClick_button_going.bind(_this7);

	    //Set state
	    _this7.state = {
	      background_color: _this7.getBackgroundColor(props.current_bar, props.index)
	    };
	    return _this7;
	  }
	  ...
	  _createClass(Result_Bar, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(Button_Going, { index: this.props.index, number_going: this.props.number_going,
	          onClick_button_going: this.onClick_button_going })
	      );
	    }
	  }]);

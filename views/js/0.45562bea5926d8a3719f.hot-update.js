...
/***/ function(module, exports, __webpack_require__) {
	...
	var Results_List = function (_React$Component) {
	  ...
	  _createClass(Results_List, [{
	    key: "componentWilReceiProps",
	    value: function componentWilReceiProps(nextProps) {
	      var _this2 = this;
	      ...
	      if (nextProps.data !== this.props.data) {
	        ...
	        nextProps.data.forEach(function (result, i) {
	          _this2.state.result_bars.push(_react2.default.createElement(Result_Bar, { key: i, title: result.title,
	  ...
	  _createClass(Result_Bar, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement("img", { className: "result_image", src: this.props.image }),
	        _react2.default.createElement(
	          "div",

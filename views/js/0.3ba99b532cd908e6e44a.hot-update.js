	...
	var Main = function (_React$Component) {
	  ...
	  _createClass(Main, [{
	    ...
	    value: function onClick_button_going(index) {
	      ...
	      xhr.open("POST", "/going-submit", true);
	      xhr.send(this.state.data_results_screen[index].id);

	      xhr.onreadystatechange = function () {
	        if (xhr.readyState === 4 && xhr.status === 200) {
	          var result = Number(xhr.responseText);
	    ...
	    value: function loadData(keyword) {
	      ...
	      xhr.onreadystatechange = function () {
	        if (xhr.readyState === 4 && xhr.status === 200) {
	          ...
	          _this3.refs.Results_Screen.setDisplay("normal");
	        }
	      };
	    }
	  }, {
	    ...
	    value: function setNotif(header, body) {
	      ...
	      setTimeout(function () {
	        _this4.setDisplay("normal");
	        _this4.refs.Notif.setDisplay("hidden");
	      }, 1000);
	    }
